        ...
        if merged_layer['name'] == layer['name']:
            ...
            for x in range(m['width']):
                ...
                for y in range(m['height']):
                    ...
                    merged_layer['data'][merged_y * merged_layer['width'] + merged_x] = layer['data'][y * layer['width'] + x]
            break
    if not found:
        new_layer = {}
        ...
        for x in range(m['width']):
            ...
            for y in range(m['height']):
                merged_y = m['offset_y'] - min_y + y
                new_layer['data'][merged_y * new_layer['width'] + merged_x] = layer['data'][y * layer['width'] + x]
